    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(default='en', max_length=8, verbose_name='Language', choices=[(b'en', b'English'), (b'it', b'Italiano'), (b'pt', b'Portugu\xc3\xaas')])),
            ],
            options={
                'ordering': ['-date_added'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('lead', models.BooleanField(default=False, verbose_name='is lead item')),
                ('group_name', models.CharField(help_text='Entries can be aggregated by group name.', max_length=50, null=True, verbose_name='group name', blank=True)),
                ('sort_order', models.IntegerField(default=0, help_text='Used to sort in ascending order, not to filter.', verbose_name='sort order')),
                ('priority', models.IntegerField(default=0, help_text='Used to filter, not to sort, possibly combined with other attributes. A large number means high priority.', verbose_name='priority')),
                ('text', models.TextField(help_text='In the case of a "lead" item, probably you will provide this text.', null=True, verbose_name='optional text', blank=True)),
                ('scope', models.IntegerField(default=0, verbose_name='scope', choices=[(0, 'any'), (1, 'global'), (2, 'project')])),
                ('object_id', models.PositiveIntegerField(null=True, blank=True)),
                ('status', models.IntegerField(default=1, null=True, verbose_name='publication state', choices=[(1, 'Draft'), (2, 'Submitted'), (3, 'Published'), (4, 'Un-published')])),
                ('start_publication', models.DateTimeField(help_text='Optional start date of publication.', null=True, verbose_name='start publication', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('small_image', models.ImageField(upload_to=b'images/resources/', null=True, verbose_name=b'small image', blank=True)),
                ('big_image', models.ImageField(upload_to=b'images/resources/', null=True, verbose_name=b'big image', blank=True)),
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(editable=False, populate_from='title', blank=True, unique=True)),
                ...
                ('path_type', models.IntegerField(choices=[(1, 'simple collection'), (2, 'sequence'), (3, 'directed graph')], verbose_name=b'path type', validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oer_type', models.IntegerField(default=2, choices=[(1, 'Metadata only'), (2, 'Metadata and online reference'), (3, 'Metadata and document(s)')], verbose_name=b'OER type', validators=[django.core.validators.MinValueValidator(1)])),
                ('source_type', models.IntegerField(default=2, choices=[(1, 'Catalogued source'), (2, 'Non-catalogued source'), (3, 'Derived-translated'), (4, 'Derived-adapted'), (5, 'Derived-remixed'), (6, 'none (brand new OER)')], verbose_name=b'source type', validators=[django.core.validators.MinValueValidator(1)])),
                ('translated', models.BooleanField(default=False, verbose_name='translated')),
                ('remixed', models.BooleanField(default=False, verbose_name='adapted / remixed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(null=True, verbose_name='own text content', blank=True)),
                ('created', django_extensions.db.fields.CreationDateTimeField(default=django.utils.timezone.now, verbose_name='created', editable=False, blank=True)),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(default=django.utils.timezone.now, verbose_name='modified', editable=False, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(editable=False, populate_from='name', blank=True, unique=True)),
                ('chat_type', models.IntegerField(default=1, null=True, verbose_name=b'chat type', choices=[(0, 'no chatroom'), (1, 'permanent chatroom')])),
        ...
        migrations.AddField(
            model_name='oer',
            name='tags',
            field=models.ManyToManyField(to='commons.Tag', verbose_name=b'tags', blank=True),
        ),
        migrations.AddField(
