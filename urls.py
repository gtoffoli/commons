...
urlpatterns = patterns('',
    ...
    url(r'^my_mail/compose/(?P<username>[\w\.-]+)/', 'commons.views.send_message_to', name='send_message_to'),
    ...
    # url(r"^project/(?P<project_slug>[\w-]+)/upload/$", 'commons.views.project_logo_upload', name="project_logo_upload"),
