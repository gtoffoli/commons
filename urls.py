...
urlpatterns = patterns('',
    ...
    url(r"^project/(?P<project_slug>[\w-]+)/edit_mm/$", 'commons.views.project_mentoring_model_edit', name="project_mentoring_model_edit"),
    url(r"^project/(?P<project_id>[\d-]+)/propose/$", 'commons.views.project_propose', name="project_propose"),
    url(r"^project/(?P<project_id>[\d-]+)/draft_back/$", 'commons.views.project_draft_back', name="project_draft_back"),
    ...
    url(r"^project/(?P<project_slug>[\w-]+)/send_one2one_message/$", 'commons.views.project_send_one2one_message', name="project_send_one2one_message"),
