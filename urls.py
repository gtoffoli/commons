...
urlpatterns += [
    ...
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/share/$", commons.views.folderdocument_share, name="folderdocument_share"),
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/submit/$", commons.views.folderdocument_submit, name="folderdocument_submit"),
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/withdraw/$", commons.views.folderdocument_withdraw, name="folderdocument_withdraw"),
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/reject/$", commons.views.folderdocument_reject, name="folderdocument_reject"),
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/publish/$", commons.views.folderdocument_publish, name="folderdocument_publish"),
    url(r"^folderdocument/(?P<folderdocument_id>[\d-]+)/un_publish/$", commons.views.folderdocument_un_publish, name="folderdocument_un_publish"),
    ...
    url(r"^oer/(?P<oer_id>[\d-]+)/share/$", commons.views.oer_share, name="oer_share"),
    ...
    url(r"^lp/(?P<lp_id>[\d-]+)/share/$", commons.views.lp_share, name="lp_share"),
    ...
    url(r"^context_dashboard/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", commons.text_analysis.context_dashboard, name="context_dashboard_2"),
    ...
    url(r"^text_wordlists/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", commons.text_analysis.text_wordlists, name="text_wordlists_2"),
    url(r"^text_wordlists/$", commons.text_analysis.text_wordlists, name="text_wordlists_0"),
    ...
    url(r"^ajax_get_corpora/$", commons.text_analysis.ajax_get_corpora, name="ajax_get_corpora"),
    url(r"^ajax_delete_corpus/$", commons.text_analysis.ajax_delete_corpus, name="ajax_delete_corpus"),
    url(r"^ajax_insert_item/$", commons.text_analysis.ajax_insert_item, name="ajax_insert_item"),
    ...
    url(r"^text_analysis/(?P<function>[\w\.-]+)/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/(?P<file_key>[\w\.-]+)/$", commons.text_analysis.text_analysis, name="text_analysis"),
    url(r"^text_analysis/(?P<function>[\w\.-]+)/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", commons.text_analysis.text_analysis, name="text_analysis"),
