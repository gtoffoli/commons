...
urlpatterns += [
    ...
    url(r"^text_dashboard/(?P<obj_type>[\w\.-]+)/<int:obj_id>/$", commons.text_analysis.text_dashboard, name="text_dashboard"),
    # url(r"^text_dashboard/(?P<obj_type>[\w\.-]+)/<path:obj_id>$", commons.text_analysis.text_dashboard, name="text_dashboard_by_url"),
